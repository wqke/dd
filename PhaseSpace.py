        ...
        if selection is None:
                ...
                if choice=='two':
                        ...
                        if choice=='B':
                                ...
                                vec3=Vector3D(newD0.x[i]/newD0.p[i],newD0.y[i]/newD0.p[i],newD0.z[i]/newD0.p[i])
                                vec4=Vector3D(newDst.x[i]/newDst.p[i],newDst.y[i]/newDst.p[i],newDst.z[i]/newDst.p[i])
                                ...
                                d2x,d2y,d2z=(norm2*angleDstx,norm2*angleDsty,norm2*angleDstz)
                                ...
                                mesh1 = go.Mesh3d(x=[angleDstx,angleQx,newtau.z[i]/newtau.p[i]*2-angleDstx,newtau.z[i]/newtau.p[i]*2+angleDstx],y=[angleDsty,angleQy,newtau.x[i]/newtau.p[i]*2-angleDsty,newtau.x[i]/newtau.p[i]*2+angleDsty],z=[angleDstz,angleQz,newtau.y[i]/newtau.p[i]*2-angleDstz,newtau.y[i]/newtau.p[i]*2+angleDstz],
                                        opacity=0.4,
                                        color='#3E3A3A')
                                mesh2 = go.Mesh3d(x=[angleDstx,angleQx,(newD0.z[i]/newD0.p[i])*10+angleQx,(newD0.z[i]/newD0.p[i])*10-angleQx],y=[angleDsty,angleQy,newD0.x[i]/newD0.p[i]*10+angleQy,angleQy,newD0.x[i]/newD0.p[i]*10-angleQy],z=[angleDstz,angleQz,(newD0.y[i]/newD0.p[i])*10+angleQz,(newD0.y[i]/newD0.p[i])*10+angleQz],
                                        opacity=0.4,
                                        color='#00cc51')
                                dataangle=[traceQ,traceDst,tracenu,tracetau,traceD0,tracepi,dash1,mesh1,mesh2]
...
def drawevent(selection,radio,frame):
        if selection is None:
                ...
                if radio=='3D':
                        [traceB,traceDst,tracetau,traceD0,tracenuB,traceK]=[go.Scatter3d(x=[PV_X,B_X],y=[PV_Y,B_Y],z=[PV_Z,B_Z],mode='lines+markers+text',marker=dict(size=5,color= "rgb(5,200,5)", opacity=0.8),text=['PV', ''],textposition='top left',line = dict(color =colorval(B) ,colorscale='Electric',width = 3)),go.Scatter3d(x=[B_X,Dst_X],y=[B_Y,Dst_Y],z=[B_Z,Dst_Z],mode='lines+markers+text',marker=dict(size=5,color="rgb(5,200,5)",opacity=0.8),text=['', 'D*'],textposition='top left',line = dict(width=3,color=colorval(Dst),colorscale='Electric')),go.Scatter3d(x=[B_X,tau_X],y=[B_Y,tau_Y],z=[B_Z,tau_Z],mode='lines+markers+text',marker=dict(size=5,color= "rgb(5,200,5)", opacity=0.8),text=['', 'tau'],textposition='top left',line = dict(color = colorval(tau),colorscale='Electric',width = 3)),go.Scatter3d(x=[Dst_X,D0_X],y=[Dst_Y,D0_Y],z=[Dst_Z,D0_Z],mode='lines+markers+text',marker=dict(size=5,color= "rgb(5,200,5)", opacity=0.8),text=['', 'D0'],textposition='top left',line = dict(color = colorval(D0),colorscale='Electric',width = 3)),go.Scatter3d(x=[B_X,nu_X],y=[B_Y,nu_Y],z=[B_Z,nu_Z],mode='lines+markers+text',marker=dict(size=5,color= "rgb(5,200,5)",opacity=0.8),text=['', 'nuB'],textposition='top left',line = dict(color = colorval(nuB),colorscale='Electric',width = 3)),go.Scatter3d(x=[D0_X,K_X],y=[D0_Y,K_Y],z=[D0_Z,K_Z],mode='lines+markers+text',marker=dict(size=5,color= "rgb(5,200,5)", opacity=0.8),text=['', 'K'],textposition='top left',line = dict(color =colorval(K),colorscale='Electric',width = 3))]
                        tracepiK=go.Scatter3d(x=[D0_X,piK_X],y=[D0_Y,piK_Y],z=[D0_Z,piK_Z],mode='lines+markers+text',marker=dict(size=5,color="rgb(5,200,5)", opacity=0.8),text=['', 'pi'],textposition='top left',line = dict(color=colorval(piK),colorscale='Electric',width = 3))

                        tracepiDst=go.Scatter3d(x=[Dst_X,piDst_X],y=[Dst_Y,piDst_Y],z=[Dst_Z,piDst_Z],mode='lines+markers+text',marker=dict(size=5,color= "rgb(5,200,5)", opacity=0.8),text=['', 'pi'],textposition='top left',line = dict(color = colorval(piDst),colorscale='Electric',width = 3))
