        ...
        if selection is None:
				...
				anglepix,anglepiy,anglepiz=(newpiD0.z[i]/newpiD0.p[i]+angleD0x,newpiD0.x[i]/newpiD0.p[i]+angleD0y,newpiD0.y[i]/newpiD0.p[i]+angleD0z)
                                ...
                                mesh1 = go.Mesh3d(x=[angleD0x,angleQx,newtau.z[i]/newtau.p[i]*2-angleD0x,newtau.z[i]/newtau.p[i]*2+angleD0x],y=[angleD0y,angleQy,newtau.x[i]/newtau.p[i]*2-angleD0y,newtau.x[i]/newtau.p[i]*2+angleD0y],z=[angleD0z,angleQz,newtau.y[i]/newtau.p[i]*2-angleD0z,newtau.y[i]/newtau.p[i]*2+angleD0z],
                                        opacity=0.4,
                                        color='#3E3A3A')
                                mesh2 = go.Mesh3d(x=[angleKx,angleQx,(newK.z[i]/newK.p[i])*10+angleQx,(newD0.z[i]/newD0.p[i])*10-angleQx],y=[angleD0y,angleQy,newK.x[i]/newK.p[i]*10+angleQy,angleQy,newD0.x[i]/newD0.p[i]*10-angleQy],z=[angleDstz,angleQz,(newD0.y[i]/newD0.p[i])*10+angleQz,(newD0.y[i]/newD0.p[i])*10+angleQz],
                                        opacity=0.4,
                                        color='#00cc51')
		...
		if frame=='lab':
			...
			K_Z=newK.y[i]*dis/newK.p[i]+D0_Z
                ...
                xrange=max(abs([PV_X,B_X,D0_X,tau_X,K_X,nutau_X,nu_X,pitau1_X,
                                pitau2_X,pitau3_X,piD0_X,piK_X]))
                yrange=max(abs([PV_Y,B_Y,D0_Y,tau_Y,K_Y,nutau_Y,nu_Y,pitau1_Y,
                         pitau2_Y,pitau3_Y,piD0_Y,piK_Y]))
                zrange=max(abs([PV_Z,B_Z,D0_Z,tau_Z,K_Z,nutau_Z,nu_Z,pitau1_Z,
                                pitau2_Z,pitau3_Z,piD0_Z,piK_Z]))

		if radio=='3D':
			[traceB,traceD0,tracetau,tracenuB,traceK]=[go.Scatter3d(x=[PV_X,B_X],y=[PV_Y,B_Y],z=[PV_Z,B_Z],mode='lines+markers+text',marker=dict(size=5,color= "rgb(5,200,5)", opacity=0.8),text=['PV', ''],textposition='top left',line = dict(color =colorval(B) ,colorscale='Electric',width = 3)),go.Scatter3d(x=[B_X,D0_X],y=[B_Y,D0_Y],z=[B_Z,D0_Z],mode='lines+markers+text',marker=dict(size=5,color="rgb(5,200,5)",opacity=0.8),text=['', 'D0'],textposition='top left',line = dict(width=3,color=colorval(D0),colorscale='Electric')),go.Scatter3d(x=[B_X,tau_X],y=[B_Y,tau_Y],z=[B_Z,tau_Z],mode='lines+markers+text',marker=dict(size=5,color= "rgb(5,200,5)", opacity=0.8),text=['', 'tau'],textposition='top left',line = dict(color = colorval(tau),colorscale='Electric',width = 3)),go.Scatter3d(x=[B_X,nu_X],y=[B_Y,nu_Y],z=[B_Z,nu_Z],mode='lines+markers+text',marker=dict(size=5,color= "rgb(5,200,5)",opacity=0.8),text=['', 'nuB'],textposition='top left',line = dict(color = colorval(nuB),colorscale='Electric',width = 3)),go.Scatter3d(x=[D0_X,K_X],y=[D0_Y,K_Y],z=[D0_Z,K_Z],mode='lines+markers+text',marker=dict(size=5,color= "rgb(5,200,5)", opacity=0.8),text=['', 'K'],textposition='top left',line = dict(color =colorval(K),colorscale='Electric',width = 3))]
			tracepiD0=go.Scatter3d(x=[D0_X,piD0_X],y=[D0_Y,piD0_Y],z=[D0_Z,piD0_Z],mode='lines+markers+text',marker=dict(size=5,color="rgb(5,200,5)", opacity=0.8),text=['', 'pi'],textposition='top left',line = dict(color=colorval(piD0),colorscale='Electric',width = 3))

                      
			tracepitau1=go.Scatter3d(x=[tau_X,pitau1_X],y=[tau_Y,pitau1_Y],z=[tau_Z,pitau1_Z],mode='lines+markers+text',marker=dict(size=5,color= "rgb(5,200,5)", opacity=0.8),text=['', 'pi'],textposition='top left',line = dict(color = colorval(pitau1),colorscale='Electric',width = 3))

			tracepitau2=go.Scatter3d(x=[tau_X,pitau2_X],y=[tau_Y,pitau2_Y],z=[tau_Z,pitau2_Z],mode='lines+markers+text',marker=dict(size=5,color= "rgb(5,200,5)", opacity=0.8),text=['', 'pi'],textposition='top left',line = dict(color = colorval(pitau2),colorscale='Electric',width = 3))


			tracepitau3=go.Scatter3d(x=[tau_X,pitau3_X],y=[tau_Y,pitau3_Y],z=[tau_Z,pitau3_Z],mode='lines+markers+text',marker=dict(size=5,color= "rgb(5,200,5)", opacity=0.8),text=['', 'pi'],textposition='top left',line = dict(color = colorval(pitau3),colorscale='Electric',width = 3))


			tracenutau=go.Scatter3d(x=[tau_X,nutau_X],y=[tau_Y,nutau_Y],z=[tau_Z,nutau_Z],mode='lines+markers+text',marker=dict(size=5,color= "rgb(5,200,5)", opacity=0.8),text=['', 'nu'],textposition='top left',line = dict(color = colorval(nutau),colorscale='Electric',width = 3))
...
if __name__ == '__main__':
    app.run_server(debug=True)
                ...
                if radio=='3D':
                        [traceB,traceD0,tracetau,tracenuB,traceK]=[go.Scatter3d(x=[PV_X,B_X],y=[PV_Y,B_Y],z=[PV_Z,B_Z],mode='lines+markers+text',marker=dict(size=5,color= "rgb(5,200,5)", opacity=0.8),text=['PV', ''],textposition='top left',line = dict(color =colorval(B) ,colorscale='Blackbody',width = 3,cmin=cmin,cmax=cmax)),go.Scatter3d(x=[B_X,D0_X],y=[B_Y,D0_Y],z=[B_Z,D0_Z],mode='lines+markers+text',marker=dict(size=5,color="rgb(5,200,5)",opacity=0.8,cmin=cmin,cmax=cmax),text=['', 'D0'],textposition='top left',line = dict(width=3,color=colorval(D0),colorscale='Blackbody',cmin=cmin,cmax=cmax)),go.Scatter3d(x=[B_X,tau_X],y=[B_Y,tau_Y],z=[B_Z,tau_Z],mode='lines+markers+text',marker=dict(size=5,color= "rgb(5,200,5)", opacity=0.8),text=['', 'tau'],textposition='top left',line = dict(color = colorval(tau),colorscale='Blackbody',width = 3,cmin=cmin,cmax=cmax)),go.Scatter3d(x=[B_X,nu_X],y=[B_Y,nu_Y],z=[B_Z,nu_Z],mode='lines+markers+text',marker=dict(size=5,color= "rgb(5,200,5)",opacity=0.8),text=['', 'nuB'],textposition='top left',line = dict(color = colorval(nuB),colorscale='Blackbody',width = 3,cmin=cmin,cmax=cmax)),go.Scatter3d(x=[D0_X,K_X],y=[D0_Y,K_Y],z=[D0_Z,K_Z],mode='lines+markers+text',marker=dict(size=5,color= "rgb(5,200,5)", opacity=0.8),text=['', 'K'],textposition='top left',line = dict(color =colorval(K),colorscale='Blackbody',width = 3,cmin=cmin,cmax=cmax))]
                        tracepiD0=go.Scatter3d(x=[D0_X,piD0_X],y=[D0_Y,piD0_Y],z=[D0_Z,piD0_Z],mode='lines+markers+text',marker=dict(size=5,color="rgb(5,200,5)", opacity=0.8),text=['', 'pi'],textposition='top left',line = dict(color=colorval(piD0),colorscale='Blackbody',width = 3,cmin=cmin,cmax=cmax))
